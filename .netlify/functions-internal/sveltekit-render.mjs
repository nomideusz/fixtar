	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/admin/clean-fake-data/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/admin/products/status/_server.ts.js'))
			},
			{
				id: "/api/auth/debug",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/auth/debug/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/auth/validate/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/baselinker/orders/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/baselinker/sync/_server.ts.js'))
			},
			{
				id: "/api/cart/merge",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/cart/merge/_server.ts.js'))
			},
			{
				id: "/api/cart/sync",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/cart/sync/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/webhooks/payment/_server.ts.js'))
			},
			{
				id: "/auth/login",
				pattern: /^\/auth\/login\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/auth/validate/_server.ts.js'))
			},
			{
				id: "/cart",
				pattern: /^\/cart\/?$/,
