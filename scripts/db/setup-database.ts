...
async function setupCategories(pb: PocketBase) {
  ...
  for (const category of categories) {
    try {
      const existing = await pb.collection('categories').getFirstListItem(`slug="${category.slug}"`);
  ...
  const products = [
    {
      name: 'iPhone 15 Pro',
      slug: 'iphone-15-pro',
      description: '<p>The iPhone 15 Pro features a titanium design, A17 Pro chip, and advanced camera system with 5x telephoto zoom.</p>',
      ...
      seo: {
        ...
        description: 'Buy the new iPhone 15 Pro with titanium design and A17 Pro chip. Free shipping available.',
    ...
    },
    {
      ...
      description: '<p>The Galaxy S24 Ultra features an integrated S Pen, 200MP camera, and AI-powered features for productivity and creativity.</p>',
      ...
      seo: {
        ...
        description: 'Experience the Galaxy S24 Ultra with S Pen, 200MP camera, and AI features. Order now with free shipping.',
    ...
    },
    {
      ...
      description: '<p>The MacBook Pro 14-inch with M3 chip delivers exceptional performance for professionals with up to 22 hours of battery life.</p>',
      ...
      seo: {
        ...
        description: 'Get the MacBook Pro 14-inch with M3 chip for professional performance. Free shipping and setup included.',
    ...
    },
    {
      ...
      description: '<p>The Dell XPS 13 Plus features a stunning InfinityEdge display, 12th Gen Intel processors, and premium build quality.</p>',
      ...
      seo: {
        ...
        description: 'Experience the Dell XPS 13 Plus with InfinityEdge display and 12th Gen Intel processors.',
    ...
    },
    {
      ...
      description: '<p>AirPods Pro (2nd generation) feature Active Noise Cancellation, Adaptive Transparency, and up to 6 hours of listening time.</p>',
      ...
      seo: {
        ...
        description: 'Get AirPods Pro with Active Noise Cancellation and Adaptive Transparency. Free shipping included.',
