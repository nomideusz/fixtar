...
| **2. Semantic tokens**   | `:root` CSS custom properties in `src/app.css`           | Map design _intent_ to palette values (`--ft-primary`, `--ft-border`, etc.). Enables dark-mode and theme switching. |
