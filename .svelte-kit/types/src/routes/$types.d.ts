...
type LayoutRouteId = RouteId | "/" | "/about" | "/account" | "/account/addresses" | "/account/addresses/new" | "/account/addresses/[id]/edit" | "/account/favorites" | "/account/orders" | "/account/settings" | "/admin" | "/admin/baselinker" | "/admin/customers" | "/admin/orders" | "/admin/products" | "/auth/login" | "/auth/logout" | "/auth/register" | "/cart" | "/categories" | "/checkout" | "/checkout/success" | "/contact" | "/deals" | "/docs" | "/orders/[id]" | "/products" | "/products/[slug]" | "/search" | "/wishlist" | "/xml-products/[id]" | null
