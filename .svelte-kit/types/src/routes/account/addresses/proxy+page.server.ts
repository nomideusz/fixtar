...
export const actions = {
    ...
    updateAddress: async ({ request, locals }: import('./$types').RequestEvent) => {
        const pb = locals.pb;
        const user = locals.user;
    ...
    removeAddress: async ({ request, locals }: import('./$types').RequestEvent) => {
        const pb = locals.pb;
        const user = locals.user;
    ...
    setDefaultAddress: async ({ request, locals }: import('./$types').RequestEvent) => {
        const pb = locals.pb;
        const user = locals.user;
