...
type LayoutRouteId = RouteId | "/account" | "/account/addresses" | "/account/addresses/new" | "/account/addresses/[id]/edit" | "/account/favorites" | "/account/orders" | "/account/settings"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/account/+layout.server.js').load>>>>>>;
