...
declare module '$env/static/private' {
	...
	export const BASELINKER_API_TOKEN: string;
	export const P24_MERCHANT_ID: string;
	export const P24_POS_ID: string;
	export const P24_CRC: string;
	export const P24_API_KEY: string;
	...
	export const EFC_5712_1592913036: string;
