...
<div class="bg-neutral-50 min-h-screen py-12">
	<div class="max-w-md mx-auto px-6">
		...
		<div class="text-center mb-8">
			...
			/>
			<h1 class="text-2xl font-bold text-neutral-900 mb-2">Logowanie</h1>
			<p class="text-neutral-600">Wprowadź swoje dane logowania</p>
		</div>
			...
			<form method="POST" use:enhance={({ formElement, formData, action, cancel, submitter }) => {
				...
				<div class="flex items-center justify-between text-sm">
					<label class="flex items-center cursor-pointer">
						...
						/>
						<span class="ml-2 text-neutral-700">Zapamiętaj mnie</span>
					</label>
